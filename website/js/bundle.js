...
document.getElementById('me').onclick = function() {
	...
	if (postcode.length)
	{
		...
		{
			lat.value = data.wgs84_lat;
			lng.value = data.wgs84_lon;

			var res = leafletPip.pointInLayer(
				[lng.value, lat.value], gjLayer);
			if (res.length) 
			{
				...
				var wardres = leafletPip.pointInLayer([lng.value, lat.value], wardLayer);
				if (wardres.length)
				{
			...
			{
				document.getElementById('me').innerHTML = 'You aren\'t in Scotland';
			}
		}
		else
		{
