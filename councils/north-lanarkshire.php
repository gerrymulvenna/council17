...
$council_name = 'North Lanarkshire';  // used in the title and breadcrumb
$mapLat = 55.8663;            // good centre position for the map
$mapLong = -3.9626;          // good centre position for the map 
