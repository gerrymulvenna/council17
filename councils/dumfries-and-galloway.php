...
$council_name = 'Dumfries and Galloway';  // used in the title and breadcrumb
$mapLat = 55.1068;              // good centre position for the map
$mapLong = -4.1626;          // good centre position for the map 
