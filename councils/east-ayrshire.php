...
$slug = 'east-ayrshire';
$council_name = 'East Ayrshire';  // used in the title and breadcrumb
$mapLat = 55.4518;            // good centre position for the map
$mapLong = -4.2644;          // good centre position for the map 
