...
$slug = 'north-ayrshire';
$council_name = 'North Ayrshire';  // used in the title and breadcrumb
$mapLat = 55.65;            // good centre position for the map
$mapLong = -5.1216;          // good centre position for the map 
