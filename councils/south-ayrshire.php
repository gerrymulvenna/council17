...
$slug = 'south-ayrshire';
$council_name = 'South Ayrshire';  // used in the title and breadcrumb
$mapLat = 55.2767;            // good centre position for the map
$mapLong = -4.7244;          // good centre position for the map 
