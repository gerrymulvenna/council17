...
$slug = 'aberdeen-city';
$council_name = 'Aberdeen City';  // used in the title and breadcrumb
$mapLat = 57.153113;            // good centre position for the map
$mapLong = -2.158562;          // good centre position for the map 
