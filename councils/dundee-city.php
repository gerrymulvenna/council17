...
$slug = 'dundee-city';
$council_name = 'Dundee City';  // used in the title and breadcrumb
$mapLat = 56.4620;              // good centre position for the map
$mapLong = -2.9707;          // good centre position for the map 
