...
$council_name = 'East Renfrewshire';  // used in the title and breadcrumb
$mapLat = 55.75;            // good centre position for the map
$mapLong = -4.383333;          // good centre position for the map 
