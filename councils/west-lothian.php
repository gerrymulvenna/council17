...
$slug = 'west-lothian';
$council_name = 'West Lothian';  // used in the title and breadcrumb
$mapLat = 55.9007;            // good centre position for the map
$mapLong = -3.5181;          // good centre position for the map 
