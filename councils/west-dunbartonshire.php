...
$council_name = 'West Dunbartonshire';  // used in the title and breadcrumb
$mapLat = 55.9789;            // good centre position for the map
$mapLong = -4.5722;          // good centre position for the map 
$mapZoom = 10;                // zoom level starting position
