...
$slug = 'the-scottish-borders';
$council_name = 'Scottish Borders';  // used in the title and breadcrumb
$mapLat = 55.5507;            // good centre position for the map
$mapLong = -2.8385;          // good centre position for the map 
