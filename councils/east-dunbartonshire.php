...
$council_name = 'East Dunbartonshire';  // used in the title and breadcrumb
$mapLat = 55.9743;            // good centre position for the map
$mapLong = -4.2029;          // good centre position for the map 
$mapZoom = 11;                // zoom level starting position
