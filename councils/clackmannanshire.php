...
$council_name = 'Clackmannanshire';  // used in the title and breadcrumb
$mapLat = 56.15;            // good centre position for the map
$mapLong = -3.7529;          // good centre position for the map 
