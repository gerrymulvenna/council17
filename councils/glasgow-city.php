...
$slug = 'glasgow-city';
$council_name = 'Glasgow City';  // used in the title and breadcrumb
$mapLat = 55.8642;            // good centre position for the map
$mapLong = -4.2518;          // good centre position for the map 
