...
$slug = 'east-lothian';
$council_name = 'East Lothian';  // used in the title and breadcrumb
$mapLat = 55.9587;            // good centre position for the map
$mapLong = -2.7749;          // good centre position for the map 
