...
$slug = 'midlothian';
$council_name = 'Midlothian';  // used in the title and breadcrumb
$mapLat = 55.8510;            // good centre position for the map
$mapLong = -3.1363;          // good centre position for the map 
