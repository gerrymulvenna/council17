...
$council_name = 'South Lanarkshire';  // used in the title and breadcrumb
$mapLat = 55.6;            // good centre position for the map
$mapLong = -3.7821;          // good centre position for the map 
$mapZoom = 9;                // zoom level starting position
