...
$council_name = 'Perth and Kinross';  // used in the title and breadcrumb
$mapLat = 56.6218;            // good centre position for the map
$mapLong = -3.8670;          // good centre position for the map 
