...
$slug = 'renfrewshire';
$council_name = 'Renfrewshire';  // used in the title and breadcrumb
$mapLat = 55.8483;            // good centre position for the map
$mapLong = -4.4933;          // good centre position for the map 
